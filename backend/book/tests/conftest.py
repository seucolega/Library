...
@pytest.fixture
def supply_book(
    supply_book_publisher,
    supply_book_age_classification,
    supply_book_textual_classification,
):
...
@pytest.fixture
def supply_book_person(
    supply_book, supply_book_person_profile, supply_book_person_type
):
...
def metabooks_product_search_json():
    return {
        ...
        'titles': [
            {'title': 'Poesia completa de Alberto Caeiro', 'titleType': '01'}
        ],
        'noContributor': False,
